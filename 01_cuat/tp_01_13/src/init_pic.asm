; https://es.wikipedia.org/wiki/Intel_8259#ICWS_(Initialization_Command_Words)
; First time using OUT cmd which puts the content of the second operand to the specified port
...
init_pic:
   ...
   out MASTER_PIC_8259_CMD_PORT, al
	...
	;   |7|6|5|4|3|2|1|0|  ICW2  => DATA PORT MASTER (0x21) Interrupt priority set
   ...
   ;  |7|6|5|4|3|2|1|0|  ICW3 for Master Device  => DATA PORT MASTER (0x21) What and how PIC are connected each other
   ...
   mov al, 0x04    ; 01000000  =>  PIC 1 Master, PIC 2 Slave conectado a IRQ2 
   out MASTER_PIC_8259_DATA_PORT, al
   ...
   mov al, 11111000b ; 11111000 => Habilito IR0, IR1
   out MASTER_PIC_8259_DATA_PORT, al
